...
<body>
    ...
    <nav class="navbar flex bg-body-tertiary">
        <div class="container">
            ...
            <button class="btn"> <a href="../controller/logoutController.php" class="dropdown-item"><svg
    ...
    <div class="container">
        <div class="row mt-4 border rounded ">
            <div class="col">
                <div class="row border rounded mb-1 bg-body-tertiary">

                    <p class="mt-3 flex text-align-center display-1 fs-5">
                ...
                <div class="row flex justify-content-center">
                    <div class="col-3 p-2 flex justify-content-center text-center">
                        <div class="row">
                            <div class="col">
                                <label class="fs-4">Listar Chamados</label>
                                <br>
                                <a href="listar_chamadosView.php"><button class="btn"><svg xmlns="http://www.w3.org/2000/svg"
                                            width="80" height="65" fill="currentColor" class="bi bi-card-list"
                                            viewBox="0 0 16 16">
                                            <path
                            ...
                            <div class="col">
                                ...
                                <label class="fs-4">Abrir Chamado</label>
                                <br>
                                <a href="abrir_chamadosView.php"><button class="btn">
